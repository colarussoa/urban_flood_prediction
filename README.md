...
<p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The inputs into the CNN from various flood drivers and it's sources are listed in <a href="#Table 1">Table 1</a>. There are various landcover datasets available: <a href="https://esa-worldcover.org/en/data-access"></a>ESA at 10 m (2020, 2021), <a href="https://dynamicworld.app/">Dynamic World</a> at 10 m (near realtime), <a href="https://swfwmd.maps.arcgis.com/apps/webappviewer/index.html?id=ff37f69f0c5744799e825f7b16586dc1">SWFWMD</a> in vector (1990-2023, 3-5 year intervals), <a href="https://myfwc.com/research/gis/wildlife/cooperative-land-cover/">FWC</a> at 10 m (Rasterized SWFWMD product), and <a href="https://www.sciencebase.gov/catalog/item/664e0d2bd34e702fe8744536">USGS</a> at 30m (1990-2023, 3-5 year intervals). The problem is 10 m may be too fine, usually these studies happen around 30 m spatial resolution area, more values in a gridded product is more data for the CNN to evalaute and the Wang et al. (2024) paper upscales it to 50 m to decrease processing time. So, I think the USGS may be the best - there's an associated error/validation, which will allow us to employ something like label smoothing (cross-entropy on soft labels), and if we work in the 10 m space, the computational time of the model may be too great, so working with the best dataset available makes the most sense to me. Maybe we can explore finer resolution after we perfect a 30 or 50 m.
</p>
